  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className="space-y-3 mb-6 bg-muted-bg p-4 rounded-lg border border-border">
        ...
        <div className="flex justify-between items-center"><span className="text-[13px] font-medium text-muted">Equity</span><span className="text-[13px] text-foreground font-semibold">{projection.ownership.toFixed(2)}%</span></div>
        <div className="flex justify-between items-center"><span className="text-[13px] font-medium text-muted">Est. annual income</span><span className="text-[13px] text-positive-400 font-semibold">€{projection.annualIncome.toFixed(0)}</span></div>
        <div className="flex justify-between items-center"><span className="text-[13px] font-medium text-muted">Est. appreciation</span><span className="text-[13px] text-positive-400 font-semibold">€{projection.appreciation.toFixed(0)}</span></div>
        <div className="flex justify-between items-center pt-2 mt-2 border-t border-border"><span className="text-[13px] font-bold text-muted">Sourcing fee</span><span className="text-[13px] text-foreground font-semibold">€{projection.fee.toFixed(0)}</span></div>
      </div>
